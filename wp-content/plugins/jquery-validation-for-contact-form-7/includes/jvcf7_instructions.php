...
<table class="wp-list-table widefat fixed bookmarks">
    ...
    <tr>
        <td>
		<h4>For available validation rules and class, please visit <a href="https://dnesscarkey.com/jquery-validation/validation-methods/">https://dnesscarkey.com/jquery-validation/validation-methods</a></h4>
        <ol>
    	<li>You can add validation rules like url, date, dateiso, number, digits, creditcard, phoneUS from the class field of contact form 7. Check the snapshot below.<br/><img src="<?php echo plugins_url('jquery-validation-for-contact-form-7/img/add_validation.png'); ?>" />
		</li>
